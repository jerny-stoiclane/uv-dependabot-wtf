...
var Pt = (n, e, r, i) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let o of gt(e))
      !wt.call(n, o) && o !== r && Ye(n, o, { get: () => e[o], enumerable: !(i = bt(e, o)) || i.enumerable });
  return n;
};
  ...
  return o.addEventListener("message", ({ data: m }) => {
    if (Xe(m)) {
      ...
      if (d === "interval") {
        ...
        if (typeof l == "number") {
          let p = i.get(l);
          if (p === void 0 || p.timerId !== a || p.timerType !== d)
...
function se({ timeout: n = 1e3 * 60 * 20, promptTimeout: e = 0, promptBeforeIdle: r = 0, element: i = at, events: o = xe, timers: u = void 0, immediateEvents: g = [], onPresenceChange: O = () => {
  ...
  (0, import_react2.useEffect)(() => {
    if (e && console.warn("⚠️ IdleTimer -- The `promptTimeout` property has been deprecated in favor of `promptBeforeIdle`. It will be removed in the next major release."), r && e)
    ...
    if (n >= Z)
      throw new Error(`❌ The value for the timeout property must fit in a 32 bit signed integer, ${Z}.`);
    if (e >= Z)
      throw new Error(`❌ The value for the promptTimeout property must fit in a 32 bit signed integer, ${Z}.`);
    if (r >= Z)
      throw new Error(`❌ The value for the promptBeforeIdle property must fit in a 32 bit signed integer, ${Z}.`);
    if (r >= n)
      throw new Error(`❌ The value for the promptBeforeIdle property must be less than the timeout property, ${n}.`);
  ...
  let x = () => {
    ...
    if (!y && !R.current && (R.current = v(), X.current(null, L)), q(t, L), E.current)
      return;
  ...
  (0, import_react2.useEffect)(() => {
    ...
    if (!_.current) {
      ...
      if (Y(), ye.current = t, ne.current = i, He.current = g, D || C)
        return;
      y ? J() : V();
    }
